...
const useStyles = makeStyles((theme) => ({
  mainWrapper: {
    background: theme.mode === 'light' ? "#f8fafc" : "rgba(10, 10, 15, 0.9)",
    backdropFilter: "blur(16px)",
    WebkitBackdropFilter: "blur(16px)",
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    borderTop: theme.mode === 'light' ? "1px solid #e2e8f0" : "1px solid rgba(255, 255, 255, 0.08)",
  ...
  dropInfo: {
    background: theme.mode === 'light' ? "#f1f5f9" : "rgba(18, 18, 28, 0.8)",
    display: "flex",
    flexDirection: "column",
    alignItems: "center",
    width: "100%",
  ...
  messageInputWrapper: {
    padding: "4px 10px",
    background: theme.mode === 'light' ? "#ffffff" : "rgba(18, 18, 28, 0.85)",
    display: "flex",
    borderRadius: 24,
    flex: 1,
    position: "relative",
    border: theme.mode === 'light' ? "1px solid #e2e8f0" : "1px solid rgba(255, 255, 255, 0.1)",
    boxShadow: theme.mode === 'light' ? "0 2px 6px rgba(0,0,0,0.03)" : "0 2px 10px rgba(0,0,0,0.25)",
  ...
  messageInputWrapperPrivate: {
    padding: "4px 10px",
    background: theme.mode === 'light' ? "#fef3c7" : "rgba(120, 53, 15, 0.3)",
    display: "flex",
    borderRadius: 24,
    flex: 1,
    position: "relative",
