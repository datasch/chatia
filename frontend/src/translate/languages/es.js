  ...
  es: {
    translations: {
      ...
      validation: {
        ...
        phonePlaceholder: "Ej: +34 612 345 678 (opcional)",
      },
      login: {
      ...
      contactImportWpModal: {
        ...
        importComplete: "Importación completada con éxito",
        importInProgress: "Importación en progreso {current} de {total} - no salga de esta pantalla hasta completar la importación",
        sheetName: "Contactos",
        columns: {
          name: "Nombre",
          number: "Número",
        ...
        sampleContact: {
          ...
          tags: "cliente, vip",
          followUp: "",
          productName: "Curso Marketing",
          productStatus: "completado",
        },
      },
      tagsContainer: {
        tagTooShort: "¡Etiqueta muy corta!",
      ...
      connections: {
        ...
        facebook: {
          success: "Página conectada con éxito!",
        },
      },
      facebookModal: {
        title: "Conectar {{channel}}",
        description: "Siga los pasos a continuación para conectar {{channel}} al sistema de atención.",
        steps: {
          step1: {
            title: "Tener una App configurada en Meta for Developers",
            description: "Necesita tener una aplicación creada en Meta for Developers con los productos Messenger e Instagram configurados.",
          },
          step2: {
            title: "Tener una Página de Facebook",
            description: "Necesita ser administrador de una Página de Facebook. Messenger se conectará a esta página.",
          },
          step3instagram: {
            title: "Cuenta Instagram Business vinculada a la Página",
            description: "Para recibir mensajes de Instagram, su cuenta de Instagram debe ser del tipo Business o Profesional y estar vinculada a su Página de Facebook.",
          },
          stepConnect: {
            title: "Autorizar la conexión",
            description: "Haga clic en el botón de abajo para iniciar sesión con su cuenta de Facebook y autorizar {{channel}} para recibir y enviar mensajes a través del sistema.",
          },
        },
        permissions: {
          title: "Permisos solicitados:",
          sendReceive: "Enviar y recibir mensajes a través de la página",
          pagesList: "Listar sus páginas de Facebook",
          managePages: "Administrar metadata de las páginas",
          instagramMessages: "Enviar y recibir mensajes de Instagram Direct",
        },
        warning: {
          title: "Importante:",
          facebook: "Después de la autorización, todas las páginas vinculadas a su cuenta se conectarán automáticamente.",
          instagram: "Su cuenta de Instagram debe ser Business/Profesional y estar vinculada a una Página de Facebook. Después de la autorización, Instagram se conectará automáticamente.",
        },
        buttons: {
          cancel: "Cancelar",
          connect: "Conectar {{channel}}",
          connecting: "Conectando...",
        },
        errors: {
          noAppIdTitle: "Configuración pendiente!",
          noAppId: "Para conectar Facebook/Instagram es necesario configurar el App ID de Meta. Acceda a Meta for Developers, cree un App y configure la variable REACT_APP_FACEBOOK_APP_ID en el sistema.",
        },
        success: {
          facebook: "Facebook Messenger conectado con éxito!",
          instagram: "Instagram Direct conectado con éxito!",
        },
      },
      showTicketOpenModal: {
        title: {
      ...
      contacts: {
        ...
        filters: {
          showLabel: "Mostrar",
          showOnlyAgenda: "Solo mi agenda",
          showAll: "Todos los contactos",
          source: "Origen",
          sourceAll: "Todos",
          sourceManual: "Manual",
          sourceWhatsappRoster: "WhatsApp (agenda)",
          sourceExcelImport: "Excel/CSV",
          sourceAutoCreated: "Auto-creados",
          sourceChatImport: "Chats"
        },
        source: {
          manual: "Creado manualmente",
          whatsappRoster: "Importado de WhatsApp",
          excelImport: "Importado de Excel/CSV",
          autoCreated: "Auto-creado por mensaje",
      ...
      promptModal: {
        ...
        models: {
          ...
          "gpt-3.5-turbo-1106": "GPT 3.5 Turbo (legado)",
      ...
      queueIntegrationModal: {
        ...
        form: {
          ...
          urlN8N: "URL",
          urlN8NWebhook: "URL del Webhook (del N8N)",
        ...
        instructions: {
          n8nTitle: "Cómo configurar la integración con N8N (paso a paso)",
          n8nStep1: "En tu N8N, crea un nuevo workflow y agrega un nodo \"Webhook\" como primer nodo (trigger).",
          n8nStep2: "En el nodo Webhook, configura el método como POST. N8N generará una URL como: https://tu-n8n.com/webhook/abc123",
          n8nStep3: "Copia esa URL del webhook y pégala en el campo \"URL del Webhook\" arriba.",
          n8nStep4: "Construye el resto de tu workflow en N8N (ej: conectar a una IA, consultar base de datos, enviar correo, etc).",
          n8nStep5: "Después de guardar aquí, ve a Conexiones (WhatsApp) o Colas y vincula esta integración. Cada mensaje recibido en esa conexión/cola se enviará automáticamente a N8N.",
          n8nDataTitle: "Datos que N8N recibirá:",
          n8nReplyTitle: "Cómo N8N responde al cliente:",
          n8nReplyOption1: "Opción 1 (más simple) - En el último nodo del workflow, usa \"Respond to Webhook\" y retorna:",
          n8nReplyOption2: "Opción 2 (más control) - Usa el nodo \"HTTP Request\" para llamar a la API directamente. Los datos apiToken y apiUrl ya vienen en el webhook:",
          n8nTip: "Consejo: El token de la API está en Conexiones > editar la conexión WhatsApp > campo Token. Pero con la Opción 1 de arriba, no necesitas preocuparte por eso - solo retorna el texto en \"reply\".",
          webhookTitle: "Cómo configurar el Webhook",
          webhookStep1: "Configura tu sistema externo para recibir solicitudes POST en el endpoint deseado.",
          webhookStep2: "Pega la URL del endpoint en el campo de arriba. Cada mensaje recibido se enviará como POST con los datos del contacto, ticket y mensaje.",
          webhookStep3: "Si el endpoint retorna { \"reply\": \"texto\" } en la respuesta, el sistema enviará automáticamente ese mensaje al cliente en WhatsApp.",
        },
        messages: {
      ...
      userModal: {
        ...
        form: {
          ...
          canViewAllContacts: "Visualizar Todos los Contactos"
        },
        tabs: {
          general: "General",
      ...
      newTicketModal: {
        ...
        queueError: "Seleccione una cola",
        close: "Cerrar",
        buttons: {
          ok: "Guardar",
          cancel: "Cancelar"
      ...
      queues: {
        ...
        confirmationModal: {
          deleteTitle: "Eliminar",
          deleteMessage: "¿Está seguro? ¡Esta acción no se puede revertir! Los tickets de esta cola seguirán existiendo, pero ya no tendrán ninguna cola asignada."
        }
      },
      queue: {
        queueData: "Datos"
      ...
      tags: {
        title: "Tags",
        confirmationModal: {
          deleteTitle: "¿Estás seguro de que quieres eliminar esta Tag?",
          deleteMessage: "Esta acción no se puede revertir."
        },
        table: {
          id: "ID",
        ...
        toasts: {
          deleted: "Tag eliminado con éxito."
        }
      },
      tagsKanban: {
        title: "Lanes",
      ...
      settings: {
        ...
        smtp: {
          ...
          subtitle: "Configure el servidor SMTP para el envío de correos de recuperación de contraseña y notificaciones.",
          preset: "Proveedor de Email",
          ...
          fromHelper: "Si está vacío, se usará el email del usuario SMTP",
          secure: "Seguridad",
          save: "Guardar Configuración",
          testConnection: "Probar Conexión",
          sendTestTitle: "Enviar Email de Prueba",
          testEmailLabel: "Email de destino",
          sendTest: "Enviar Prueba",
          fillRequired: "Complete Host, Usuario y Contraseña.",
          fillTestEmail: "Complete el email de destino.",
          saveSuccess: "Configuración SMTP guardada con éxito!",
          saveError: "Error al guardar configuración SMTP.",
          testError: "Error al probar conexión SMTP.",
          sendTestError: "Error al enviar email de prueba."
        },
        settingsConfig: {
          userCreation: {
          ...
          options: {
            ...
            translateApiKeyHelper: "Clave de la API OpenAI para traducción automática. Si está vacío, usa la clave del primer Prompt configurado.",
            sendWelcomeMessage: "Mensaje de bienvenida al registrarse",
            welcomeMessageTemplate: "Modelo del mensaje de bienvenida",
            welcomeMessageHelper: "Use variables: {name}, {companyName}, {email}, {phone}, {trialDate}. Si está vacío, usa el modelo predeterminado.",
          },
          customMessages: {
      ...
      messagesInput: {
        ...
        translateTooltip: "Su mensaje será traducido a"
      },
      contactDrawer: {
      ...
      messageInput: {
        ...
        tooltip: {
          ...
          language: "Idioma del contacto — define a qué idioma se traducirá el mensaje",
        },
        type: {
      ...
      backendErrors: {
        ...
        ERR_USER_EMAIL_ALREADY_EXISTS: "Este email ya está en uso. Utilice otro email.",
        ERR_COMPANY_INVALID_NAME: "El nombre de la organización debe tener al menos 2 caracteres.",
        ERR_COMPANY_DUPLICATE_FIELD: "Ya existe un registro con estos datos.",
        ERR_COMPANY_CREATION_FAILED: "Error al crear la empresa. Inténtelo de nuevo.",
      ...
      flowBuilderConfig: {
        ...
        messages: {
          ...
          intervalFormatted: "Intervalo {{value}} {{unit}}",
          businessHoursLabel: "Hor. Laboral",
          units: {
            seconds: "seg.",
            minutes: "min.",
            hours: "h",
      ...
      flowBuilderModals: {
        ...
        intervalModal: {
          ...
          fields: {
            ...
            businessHoursHelp: "El mensaje se enviará solo durante el horario laboral configurado",
            startTime: "Inicio",
            endTime: "Fin",
          ...
          validation: {
            ...
            maxTime: "Valor máximo alcanzado para esta unidad",
            maxSeconds: "Máximo de 120 segundos",
            maxMinutes: "Máximo de 120 minutos",
            maxHours: "Máximo de 72 horas",
            maxDays: "Máximo de 30 días",
          }
        },
        typebotModal: {
          titleAdd: "Agregar Typebot al flujo",
          titleEdit: "Editar Typebot",
          buttonAdd: "Agregar",
          buttonEdit: "Guardar",
          fields: {
            url: "URL del Typebot",
            slug: "Slug del Bot (identificador)",
            expires: "Expiración de sesión (minutos)",
            delay: "Intervalo entre mensajes (ms)",
            keywordFinish: "Palabra para finalizar",
            keywordRestart: "Palabra para reiniciar",
            unknownMessage: "Mensaje de opción inválida",
            restartMessage: "Mensaje al reiniciar",
          },
          instructions: {
            title: "Cómo configurar Typebot (paso a paso)",
            step1: "Ten una instancia de Typebot corriendo (self-hosted o Typebot Cloud en typebot.io). Anota la URL base, ej: https://typebot.tuempresa.com",
            step2: "En el panel de Typebot, crea o abre el bot que deseas usar. El Slug es el identificador del bot en la URL — ej: si la URL del bot es typebot.io/mi-bot, el slug es \"mi-bot\".",
            step3: "En el campo \"URL del Typebot\" arriba, pega la URL base de tu instancia (sin barra al final). En el campo \"Slug\", pega el identificador del bot.",
            step4: "Configura la expiración de sesión (en minutos). Después de ese tiempo sin interacción, se iniciará una nueva conversación. Valor 0 = nunca expira.",
            step5: "Opcionalmente, define palabras clave para finalizar (ej: \"salir\") o reiniciar (ej: \"reiniciar\") la conversación con el bot.",
            variablesTitle: "Variables disponibles en Typebot:",
            varNumber: "Número del contacto en WhatsApp",
            ...
            tip: "Consejo: Typebot soporta textos, imágenes, audios, videos y botones de selección. Todos se envían automáticamente por WhatsApp.",
          },
        },
        menuModal: {
          ...
          fields: {
            ...
            typeOption: "Escriba {{number}}",
            optionPlaceholder: "Escriba opción"
          },
          invalidOption: {
            title: "Opción inválida",
            messageLabel: "Mensaje para opción inválida",
            placeholder: "Ej: Opción inválida. Por favor, elija una de las opciones a continuación:",
            helperText: "Si se completa, cuando el cliente envíe algo fuera de las opciones, este mensaje será enviado y el menú se mostrará nuevamente."
          },
          timeout: {
            title: "Timeout (sin respuesta)",
            label: "Tiempo en segundos (0 = desactivado)",
            helperText: "Si el cliente no responde en {{seconds}}s, el flujo sigue por el camino de timeout (salida naranja)"
          }
        },
        singleBlockModal: {
        ...
        openaiModal: {
          ...
          instructions: {
            title: "Cómo configurar OpenAI (paso a paso)",
            step1: "Accede a platform.openai.com y crea una cuenta. En el menú lateral, ve a \"API Keys\" y haz clic en \"Create new secret key\". Copia la clave generada.",
            step2: "Pega la clave en el campo \"API Key\" arriba. Esta clave es secreta — no la compartas con nadie.",
            step3: "En el campo \"Prompt\", escribe las instrucciones de comportamiento de la IA. Ejemplo: \"Eres un asistente virtual de la empresa X. Responde de forma educada y objetiva sobre nuestros productos y servicios.\"",
            step4: "Elige el modelo: GPT-4o Mini es la mejor relación calidad-precio para atención al cliente. GPT-4.1 es más inteligente pero más caro. GPT-3.5 Turbo es el más barato.",
            step5: "La temperatura controla la creatividad (0 = respuestas exactas, 1 = respuestas creativas). Para atención al cliente, usa entre 0.3 y 0.7. Max Tokens limita el tamaño de la respuesta.",
            promptTipTitle: "Consejos para un buen prompt:",
            promptTip: "Sé específico sobre el rol de la IA, el tono de voz, los productos/servicios de la empresa y lo que NO debe hacer. Cuanto más detallado el prompt, mejores las respuestas.",
            tip: "Consejo: El campo \"Máx. Mensajes\" define cuántos mensajes de contexto recuerda la IA. Valores mayores = respuestas más contextuales pero cuestan más tokens.",
          },
        },
        geminiModal: {
          instructions: {
            title: "Cómo configurar Gemini IA (paso a paso)",
            step1: "Accede a aistudio.google.com e inicia sesión con tu cuenta de Google. Haz clic en \"Get API Key\" y luego \"Create API key\". Copia la clave generada.",
            step2: "Pega la clave en el campo \"API Key (Google AI)\" arriba. Esta clave es secreta — no la compartas con nadie.",
            step3: "En el campo \"Prompt\", escribe las instrucciones de comportamiento de la IA. Ejemplo: \"Eres un asistente virtual de la empresa X. Responde de forma educada y objetiva.\"",
            step4: "Elige el modelo: Gemini 2.5 Flash es la mejor relación calidad-precio. Gemini 2.5 Pro es más inteligente pero más lento. Gemini 2.0 Flash es el más rápido.",
            step5: "La temperatura controla la creatividad (0 = respuestas exactas, 1 = respuestas creativas). Para atención al cliente, usa entre 0.3 y 0.7.",
            promptTipTitle: "Consejos para un buen prompt:",
            promptTip: "Sé específico sobre el rol de la IA, el tono de voz, los productos/servicios y lo que NO debe hacer. Cuanto más detallado, mejores las respuestas.",
            tip: "Consejo: Gemini de Google tiene un plan gratuito generoso. Ideal para empezar a probar sin costos.",
          },
        },
        questionModal: {
