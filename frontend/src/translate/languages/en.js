  ...
  en: {
    translations: {
      ...
      facebookModal: {
        ...
        description: "Follow the steps below to connect {{channel}} to the support system.",
        steps: {
          step1: {
            title: "Have an App configured on Meta for Developers",
            description: "You need to have an application created on Meta for Developers with Messenger and Instagram products configured.",
          },
          step2: {
            title: "Have a Facebook Page",
            description: "You need to be an administrator of a Facebook Page. Messenger will be connected to this page.",
          },
          step3instagram: {
            title: "Instagram Business account linked to the Page",
            description: "To receive Instagram messages, your Instagram account needs to be Business or Professional type and linked to your Facebook Page.",
          },
          stepConnect: {
            title: "Authorize the connection",
            description: "Click the button below to log in with your Facebook account and authorize {{channel}} to receive and send messages through the system.",
          },
        },
        permissions: {
          title: "Requested permissions:",
          sendReceive: "Send and receive messages through the page",
          pagesList: "List your Facebook pages",
          managePages: "Manage page metadata",
          instagramMessages: "Send and receive Instagram Direct messages",
        },
        warning: {
          title: "Important:",
          facebook: "After authorization, all pages linked to your account will be connected automatically.",
          instagram: "Your Instagram account needs to be Business/Professional and linked to a Facebook Page. After authorization, Instagram will be connected automatically.",
        },
        buttons: {
          cancel: "Cancel",
        ...
        errors: {
          noAppIdTitle: "Configuration pending!",
          noAppId: "To connect Facebook/Instagram you need to configure the Meta App ID. Go to Meta for Developers, create an App and set the REACT_APP_FACEBOOK_APP_ID variable in the system.",
        },
        success: {
          facebook: "Facebook Messenger connected successfully!",
          instagram: "Instagram Direct connected successfully!",
        },
      },
      showTicketOpenModal: {
        title: {
      ...
      promptModal: {
        ...
        models: {
          ...
          "gpt-3.5-turbo-1106": "GPT 3.5 Turbo (legacy)",
      ...
      queueIntegrationModal: {
        ...
        form: {
          ...
          urlN8N: "URL",
          urlN8NWebhook: "Webhook URL (from N8N)",
        ...
        instructions: {
          n8nTitle: "How to set up N8N integration (step by step)",
          n8nStep1: "In your N8N, create a new workflow and add a \"Webhook\" node as the first node (trigger).",
          n8nStep2: "In the Webhook node, set the method to POST. N8N will generate a URL like: https://your-n8n.com/webhook/abc123",
          n8nStep3: "Copy that webhook URL and paste it in the \"Webhook URL\" field above.",
          n8nStep4: "Build the rest of your workflow in N8N (e.g., connect to an AI, query a database, send an email, etc).",
          n8nStep5: "After saving here, go to Connections (WhatsApp) or Queues and link this integration. Every message received on that connection/queue will be automatically sent to N8N.",
          n8nDataTitle: "Data that N8N will receive:",
          n8nReplyTitle: "How N8N replies to the customer:",
          n8nReplyOption1: "Option 1 (simplest) - In the last node of the workflow, use \"Respond to Webhook\" and return:",
          n8nReplyOption2: "Option 2 (more control) - Use the \"HTTP Request\" node to call the API directly. The apiToken and apiUrl are already included in the webhook:",
          n8nTip: "Tip: The API token is in Connections > edit the WhatsApp connection > Token field. But with Option 1 above, you don't need to worry about it - just return the text in \"reply\".",
          webhookTitle: "How to set up the Webhook",
          webhookStep1: "Configure your external system to receive POST requests at the desired endpoint.",
          webhookStep2: "Paste the endpoint URL in the field above. Each received message will be sent as a POST with contact, ticket, and message data.",
          webhookStep3: "If the endpoint returns { \"reply\": \"text\" } in the response, the system will automatically send that message to the customer on WhatsApp.",
        },
        messages: {
      ...
      settings: {
        ...
        smtp: {
          ...
          subtitle: "Configure the SMTP server for sending password recovery emails and notifications.",
          preset: "Email Provider",
          presetCustom: "Custom",
          host: "SMTP Server",
          port: "Port",
          user: "Username / Email",
          password: "Password",
          from: "Sender Email",
          fromHelper: "If empty, the SMTP username will be used",
          secure: "Security",
          save: "Save Settings",
          ...
          sendTest: "Send Test",
          fillRequired: "Fill in Host, Username and Password.",
          fillTestEmail: "Fill in the recipient email.",
          saveSuccess: "SMTP settings saved successfully!",
          saveError: "Error saving SMTP settings.",
          testError: "Error testing SMTP connection.",
          sendTestError: "Error sending test email.",
        },
        settingsConfig: {
          userCreation: {
            name: "User creation",
          ...
          options: {
            ...
            sendWelcomeMessage: "Welcome message on signup",
            welcomeMessageTemplate: "Welcome message template",
            welcomeMessageHelper: "Use variables: {name}, {companyName}, {email}, {phone}, {trialDate}. If empty, uses the default template.",
          },
          customMessages: {
      ...
      messageInput: {
        ...
        tooltip: {
          ...
          language: "Contact language — defines which language the message will be translated to",
        },
        type: {
      ...
      backendErrors: {
        ...
        ERR_USER_EMAIL_ALREADY_EXISTS: "This email is already in use. Please use a different email.",
        ERR_COMPANY_INVALID_NAME: "Organization name must be at least 2 characters.",
        ERR_COMPANY_DUPLICATE_FIELD: "An account with these details already exists.",
        ERR_COMPANY_CREATION_FAILED: "Error creating the company. Please try again.",
      ...
      flowBuilderConfig: {
        ...
        messages: {
          ...
          intervalFormatted: "Interval {{value}} {{unit}}",
      ...
      flowBuilderModals: {
        ...
        intervalModal: {
          ...
          fields: {
            ...
            businessHoursHelp: "The message will only be sent during configured business hours",
            startTime: "Start",
            endTime: "End",
          ...
          validation: {
            ...
            maxTime: "Maximum value reached for this unit",
            maxSeconds: "Maximum 120 seconds",
            maxMinutes: "Maximum 120 minutes",
            maxHours: "Maximum 72 hours",
            maxDays: "Maximum 30 days",
          }
        },
        typebotModal: {
          titleAdd: "Add Typebot to flow",
          titleEdit: "Edit Typebot",
          buttonAdd: "Add",
          buttonEdit: "Save",
          fields: {
            url: "Typebot URL",
            slug: "Bot Slug (identifier)",
            expires: "Session expiration (minutes)",
            delay: "Delay between messages (ms)",
            keywordFinish: "Keyword to finish",
            keywordRestart: "Keyword to restart",
            unknownMessage: "Invalid option message",
            restartMessage: "Restart message",
          },
          instructions: {
            title: "How to set up Typebot (step by step)",
            step1: "Have a Typebot instance running (self-hosted or Typebot Cloud at typebot.io). Note the base URL, e.g.: https://typebot.yourcompany.com",
            step2: "In the Typebot dashboard, create or open the bot you want to use. The Slug is the bot identifier in the URL — e.g., if the bot URL is typebot.io/my-bot, the slug is \"my-bot\".",
            step3: "In the \"Typebot URL\" field above, paste your instance's base URL (without trailing slash). In the \"Slug\" field, paste the bot identifier.",
            step4: "Set the session expiration (in minutes). After this time without interaction, a new conversation will start. Value 0 = never expires.",
            step5: "Optionally, set keywords to finish (e.g., \"exit\") or restart (e.g., \"restart\") the bot conversation.",
            variablesTitle: "Variables available in Typebot:",
            varNumber: "Contact's WhatsApp number",
            varPushName: "Contact's WhatsApp name",
            varRemoteJid: "Contact's full ID (JID)",
            jsonTitle: "Advanced commands (JSON):",
            jsonDesc: "In Typebot, send a message starting with # to execute actions in Gissap CRM:",
            jsonStop: "Stops the bot and transfers to an agent",
            jsonQueue: "Transfers to queue ID 1",
            jsonUser: "Transfers to queue 1, agent 5",
            tip: "Tip: Typebot supports text, images, audio, video, and choice buttons. All are automatically sent via WhatsApp.",
          },
        },
        menuModal: {
          ...
          invalidOption: {
            ...
            messageLabel: "Invalid option message",
            placeholder: "E.g.: Invalid option. Please choose one of the options below:",
            helperText: "If filled, when the client sends something outside the options, this message will be sent and the menu will be reshown."
          },
          timeout: {
            title: "Timeout (no response)",
            label: "Time in seconds (0 = disabled)",
            helperText: "If the client doesn't respond within {{seconds}}s, the flow follows the timeout path (orange exit)"
          }
        },
        singleBlockModal: {
        ...
        openaiModal: {
          ...
          instructions: {
            title: "How to set up OpenAI (step by step)",
            step1: "Go to platform.openai.com and create an account. In the sidebar, go to \"API Keys\" and click \"Create new secret key\". Copy the generated key.",
            step2: "Paste the key in the \"API Key\" field above. This key is secret — do not share it with anyone.",
            step3: "In the \"Prompt\" field, write the AI behavior instructions. Example: \"You are a virtual assistant for company X. Respond politely and objectively about our products and services.\"",
            step4: "Choose the model: GPT-4o Mini is the best value for customer service. GPT-4.1 is smarter but costs more. GPT-3.5 Turbo is the cheapest.",
            step5: "Temperature controls creativity (0 = exact answers, 1 = creative answers). For customer service, use between 0.3 and 0.7. Max Tokens limits the response length.",
            promptTipTitle: "Tips for a good prompt:",
            promptTip: "Be specific about the AI's role, tone of voice, company products/services, and what it should NOT do. The more detailed the prompt, the better the responses.",
            tip: "Tip: The \"Max Messages\" field defines how many context messages the AI remembers. Higher values = more contextual answers but cost more tokens.",
          },
        },
        geminiModal: {
          instructions: {
            title: "How to set up Gemini AI (step by step)",
            step1: "Go to aistudio.google.com and sign in with your Google account. Click \"Get API Key\" then \"Create API key\". Copy the generated key.",
            step2: "Paste the key in the \"API Key (Google AI)\" field above. This key is secret — do not share it with anyone.",
            step3: "In the \"Prompt\" field, write the AI behavior instructions. Example: \"You are a virtual assistant for company X. Respond politely and objectively.\"",
            step4: "Choose the model: Gemini 2.5 Flash is the best value. Gemini 2.5 Pro is smarter but slower. Gemini 2.0 Flash is the fastest.",
            step5: "Temperature controls creativity (0 = exact answers, 1 = creative answers). For customer service, use between 0.3 and 0.7.",
            promptTipTitle: "Tips for a good prompt:",
            promptTip: "Be specific about the AI's role, tone of voice, products/services, and what it should NOT do. The more detailed, the better the responses.",
            tip: "Tip: Google's Gemini has a generous free tier. Ideal for testing without costs.",
          },
        },
        questionModal: {
