const env = {
  ...
  REACT_APP_NAME_SYSTEM: process.env.REACT_APP_NAME_SYSTEM || "Gissap CRM",
  ...
  REACT_APP_PRIMARY_COLOR: process.env.REACT_APP_PRIMARY_COLOR || "#06b6d4",
  REACT_APP_PRIMARY_DARK: process.env.REACT_APP_PRIMARY_DARK || "#3b82f6"
};
export default env;
