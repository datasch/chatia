...
const useStyles = makeStyles((theme) => ({
    mainPaper: {
        ...
        backgroundColor: theme.palette.type === "dark" ? "rgba(18, 18, 28, 0.8)" : "#ffffff",
    ...
    excelTable: {
        ...
        "& th": {
            ...
            padding: "12px 10px",
            borderRight: `1px solid ${theme.palette.type === "dark" ? "rgba(255,255,255,0.06)" : "#f1f5f9"}`,
            borderBottom: `1px solid ${theme.palette.type === "dark" ? "rgba(255,255,255,0.08)" : "#e2e8f0"}`,
            verticalAlign: "middle",
        },
        "& td": {
            fontSize: 13,
            padding: "10px 8px",
            borderRight: `1px solid ${theme.palette.type === "dark" ? "rgba(255,255,255,0.04)" : "#f8fafc"}`,
    ...
    zebraRow: {
        ...
        "&:hover": {
            backgroundColor: theme.palette.type === "dark" ? "rgba(6, 182, 212, 0.08)" : "rgba(6, 182, 212, 0.04)",
        },
    },
    headerCell: {
        display: "flex",
